...
-- Índices para melhor performance
CREATE INDEX idx_backups_user_id ON controle_financeiro_backups(user_id);
CREATE INDEX idx_backups_backup_date ON controle_financeiro_backups(backup_date);
CREATE INDEX idx_backups_created_at ON controle_financeiro_backups(created_at DESC);
